...
Here, we follow the MNIST example from [the Flux model zoo](https://github.com/FluxML/model-zoo/blob/298ae5e59a784327132cb50f093562d672915f48/vision/mnist/conv.jl#L55). For convenience

```julia
using Flux, Flux.Data.MNIST, Statistics
using Flux: onehotbatch, onecold, logitcrossentropy
using Base.Iterators: partition
using Printf, CPUTime
...
function train(; kws...)	
    ...
    best_acc = 0.0
    last_improvement = 0
    @time @CPUtime for epoch_idx in 1:args.epochs
        ...
        if acc >= best_acc
            ...
            @info(" -> New best accuracy! Old: $(best_acc), new: $acc")
